...
class TacheResourceIT {
    ...
    private static final Duration DEFAULT_DURE_ESTIME = Duration.ofHours(6);
    private static final Duration UPDATED_DURE_ESTIME = Duration.ofHours(12);
    ...
    public static Tache createEntity(EntityManager em) {
        Tache tache = new Tache().nom(DEFAULT_NOM).dureEstime(DEFAULT_DURE_ESTIME).description(DEFAULT_DESCRIPTION).etat(DEFAULT_ETAT);
        return tache;
    }
    ...
    public static Tache createUpdatedEntity(EntityManager em) {
        Tache tache = new Tache().nom(UPDATED_NOM).dureEstime(UPDATED_DURE_ESTIME).description(UPDATED_DESCRIPTION).etat(UPDATED_ETAT);
        return tache;
    }
    ...
    void createTache() throws Exception {
        ...
        assertThat(testTache.getDureEstime()).isEqualTo(DEFAULT_DURE_ESTIME);
    ...
    @Test
    @Transactional
    void checkDureEstimeIsRequired() throws Exception {
        int databaseSizeBeforeTest = tacheRepository.findAll().size();
        // set the field null
        tache.setDureEstime(null);
    ...
    void getAllTaches() throws Exception {
        ...
        restTacheMockMvc
            ...
            .andExpect(jsonPath("$.[*].dureEstime").value(hasItem(DEFAULT_DURE_ESTIME.toString())))
    ...
    void getTache() throws Exception {
        ...
        restTacheMockMvc
            ...
            .andExpect(jsonPath("$.dureEstime").value(DEFAULT_DURE_ESTIME.toString()))
    ...
    void putNewTache() throws Exception {
        ...
        updatedTache.nom(UPDATED_NOM).dureEstime(UPDATED_DURE_ESTIME).description(UPDATED_DESCRIPTION).etat(UPDATED_ETAT);
        ...
        assertThat(testTache.getDureEstime()).isEqualTo(UPDATED_DURE_ESTIME);
    ...
    void partialUpdateTacheWithPatch() throws Exception {
        ...
        partialUpdatedTache.nom(UPDATED_NOM).dureEstime(UPDATED_DURE_ESTIME);
    ...
    void fullUpdateTacheWithPatch() throws Exception {
        ...
        partialUpdatedTache.nom(UPDATED_NOM).dureEstime(UPDATED_DURE_ESTIME).description(UPDATED_DESCRIPTION).etat(UPDATED_ETAT);
