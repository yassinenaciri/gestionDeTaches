...
class DirectionResourceIT {
    ...
    public static Direction createEntity(EntityManager em) {
        Direction direction = new Direction().nomDirection(DEFAULT_NOM_DIRECTION);
        // Add required entity
        Chef chef;
    ...
    public static Direction createUpdatedEntity(EntityManager em) {
        Direction direction = new Direction().nomDirection(UPDATED_NOM_DIRECTION);
        // Add required entity
        Chef chef;
        if (TestUtil.findAll(em, Chef.class).isEmpty()) {
    ...
    void createDirection() throws Exception {
        ...
        assertThat(testDirection.getNomDirection()).isEqualTo(DEFAULT_NOM_DIRECTION);
    }
    ...
    @Test
    @Transactional
    void checkNomDirectionIsRequired() throws Exception {
        int databaseSizeBeforeTest = directionRepository.findAll().size();
        // set the field null
        direction.setNomDirection(null);
    ...
    void getAllDirections() throws Exception {
        ...
        restDirectionMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomDirection").value(hasItem(DEFAULT_NOM_DIRECTION)));
    }
    ...
    void getDirection() throws Exception {
        ...
        restDirectionMockMvc
            ...
            .andExpect(jsonPath("$.nomDirection").value(DEFAULT_NOM_DIRECTION));
    }
    ...
    void putNewDirection() throws Exception {
        ...
        updatedDirection.nomDirection(UPDATED_NOM_DIRECTION);
        ...
        Direction testDirection = directionList.get(directionList.size() - 1);
        assertThat(testDirection.getNomDirection()).isEqualTo(UPDATED_NOM_DIRECTION);
    }
    ...
    void fullUpdateDirectionWithPatch() throws Exception {
        ...
        partialUpdatedDirection.nomDirection(UPDATED_NOM_DIRECTION);
