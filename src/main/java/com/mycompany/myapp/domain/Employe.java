...
public class Employe implements Serializable {
    ...
    public Employe affectations(Set<Historique> historiques) {
        this.setAffectations(historiques);
        return this;
    }

    public Employe addAffectations(Historique historique) {
        this.affectations.add(historique);
        historique.setCadre(this);
        return this;
    }

    public Employe removeAffectations(Historique historique) {
        this.affectations.remove(historique);
        historique.setCadre(null);
        return this;
    }

    public void setAffectations(Set<Historique> historiques) {
        if (this.affectations != null) {
            this.affectations.forEach(i -> i.setCadre(null));
        }
        if (historiques != null) {
            historiques.forEach(i -> i.setCadre(this));
        }
