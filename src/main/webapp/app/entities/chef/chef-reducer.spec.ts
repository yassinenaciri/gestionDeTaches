...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './chef.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHEF_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHEF actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHEF actions', async () => {
      const expectedActions = [
        {
