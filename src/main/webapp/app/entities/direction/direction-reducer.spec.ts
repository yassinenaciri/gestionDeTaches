...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './direction.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIRECTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_DIRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DIRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DIRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DIRECTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DIRECTION actions', async () => {
      const expectedActions = [
        {
