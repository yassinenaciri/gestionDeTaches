    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nomPole">
              <Translate contentKey="gestionDeTachesApp.pole.nomPole">Nom Pole</Translate>
            </span>
          </dt>
          <dd>{poleEntity.nomPole}</dd>
          <dt>
          ...
          <dd>{poleEntity.direction ? poleEntity.direction.nomDirection : ''}</dd>
        </dl>
