...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pole.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLE actions', async () => {
      const expectedActions = [
        {
