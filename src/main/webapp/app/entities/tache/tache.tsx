            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="gestionDeTachesApp.tache.nom">Nom</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('dureEstime')}>
                  <Translate contentKey="gestionDeTachesApp.tache.dureEstime">Dure Estime</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {tacheList.map((tache, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{tache.nom}</td>
                  <td>{tache.dureEstime ? <DurationFormat value={tache.dureEstime} /> : null}</td>
                  <td>{tache.description}</td>
                  <td>{tache.etat ? 'true' : 'false'}</td>
                  <td>{tache.service ? <Link to={`i-service/${tache.service.id}`}>{tache.service.nom}</Link> : ''}</td>
