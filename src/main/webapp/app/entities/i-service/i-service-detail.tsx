    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="nomService">
              <Translate contentKey="gestionDeTachesApp.iService.nomService">Nom Service</Translate>
            </span>
          </dt>
          <dd>{iServiceEntity.nomService}</dd>
          <dt>
          ...
          <dd>{iServiceEntity.division ? iServiceEntity.division.nomDivision : ''}</dd>
        </dl>
