...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './i-service.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISERVICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ISERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISERVICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISERVICE actions', async () => {
      const expectedActions = [
        {
